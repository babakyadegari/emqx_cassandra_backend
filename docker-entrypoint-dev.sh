...
cd /emqx_cassandra_backend/src/

erlc -I ../include/ -I /emqx-rel/_build/emqx/lib/ cassandra_cli.erl
erlc -I ../include/ -I /emqx-rel/_build/emqx/lib/ emqx_auth_cassandra.erl
erlc -I ../include/ -I /emqx-rel/_build/emqx/lib/ emqx_cassandra_backend.erl
erlc -I ../include/ -I /emqx-rel/_build/emqx/lib/ emqx_cassandra_backend_sup.erl
erlc -I ../include/ -I /emqx-rel/_build/emqx/lib/ emqx_acl_cassandra.erl
erlc -I ../include/ -I /emqx-rel/_build/emqx/lib/ emqx_auth_cassandra_cli.erl
erlc -I ../include/ -I /emqx-rel/_build/emqx/lib/ emqx_cassandra_backend_app.erl
find /emqx-rel/_build/emqx/rel/emqx/lib/ -name 'emqx_cassandra_backend*' -type d -exec cp *.beam {}/ebin/ \;

ln -s /emqx-rel/_build/emqx/rel/emqx/ /opt/emqx

# /emqx-rel/_build/emqx/rel/emqx/bin/emqx console
# tail -f /dev/null
...
/opt/emqx/bin/emqx console || emqx_exit
